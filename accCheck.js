...
/*Function to count the total number of tag*/
	...
	function accCheck(){
		...
		if(!$("#accCheckDiv").length){
			...
			var accCheckAppend = $("<div id='accCheckDiv' class='well'><a class='pull-left' href='javascript:enableSrolling();'>Scroll</a> | <span class='badge'>" + htmlcounter + "</span> &lthtml&gt without lang <a class='pull-right' href='#' id='sair' style='color: white'><i class='fa fa-power-off fa-lg'></i></a><br><br><div id='accNav' style='height: 90%'></div></div>");
