...
/*Function to count the total number of tag*/
	...
	function accCheck(){
		...
		if(!$("#accCheckDiv").length){
			...
			sidenav +=         '<li>';
			sidenav +=          	'<a href="javascript: changechkbox(\'imgtag\')"><span class="badge">' + imgcounter + '</span> Images/Icons without alt <input id="imgSelector" type="radio" class="pull-right" name="imgtag" value="' + imglink + '"></a>';
			sidenav +=         '</li>';
			sidenav +=         '<li>';
			sidenav +=             '<a href="javascript: changechkbox(\'htmllang\')"><span class="badge">' + htmlcounter + '</span> &lthtml&gt without lang <input id="htmlSelector" type="radio" class="pull-right" name="htmllang" value="' + htmllink + '"></a>';
			sidenav +=         '</li>';
			sidenav +=         '<li>';
			sidenav +=             '<a href="javascript: changechkbox(\'tablesum\')"><span class="badge">' + tablecounter + '</span> &lttable&gt without summary <input id="tableSelector" type="radio" class="pull-right" name="tablesum" value="' + tablelink + '"></a>';
			sidenav +=         '</li>';
			sidenav +=         '<li>';
			sidenav +=          	'<a href="javascript: changechkbox(\'dupid\')"><span class="badge">' + duplicatedcounter + '</span> Duplicated IDs <input id="dupSelector" type="radio" class="pull-right" name="dupid" value="' + duplicatedlink + '"></a>';
			sidenav +=         '</li>';
			sidenav +=         '<li>';
			sidenav +=          	'<a href="javascript: changechkbox(\'sellabel\')"><span class="badge">' + labelcounter + '</span> Labels <input id="labelSelector" type="radio" class="pull-right" id="labellink" name="sellabel" value="' + labellinks + '"></a>';
			sidenav +=         '</li>';
			sidenav +=         '<li>';
