...
/*Function to count the total number of tag*/
	...
	function accCheck(){
		...
		if(!$("#accCheckDiv").length){
			...
			sidenav +=         '<li>';
			sidenav +=          	'<a href="javascript: changechkbox(\'imgtag\',\'' + jqt + '\')"><span class="badge">' + imgcounter + '</span> &ltimg&gt without alt <input id="imgtag" type="radio" class="pull-right" name="imgtag" value="' + imglink + '"></a>';
			sidenav +=         '</li>';
			sidenav +=         '<li>';
